...
//                     <TopItem href="/custom" icon={icon0}>聊天窗口</TopItem>
//                 </div>
//                 <div className={styles.bottomMenu}>
//                     {/* 增加一个小横线，颜色为白色 */}
//                     {/* <div className={`line ${styles.line}`} id='2'></div> */}
//                     <BottomMenuItem href="/custom" icon={icon1}>定制需求</BottomMenuItem>
//                     <BottomMenuItem href="/custom" icon={icon2}>清除所有会话</BottomMenuItem>
//                     <BottomMenuItem href="/custom" icon={icon3}>联系客服</BottomMenuItem>
//                     <BottomMenuItem href="/custom" icon={icon4}>升级会员</BottomMenuItem>
//                     <BottomMenuItem href="/custom" icon={icon5}>订单记录</BottomMenuItem>
//                     <BottomMenuItem href="/contact" icon={icon6}>操作指南</BottomMenuItem>
//                     <BottomMenuItem href="/contact" icon={icon7}>免责声明</BottomMenuItem>
//                     <BottomMenuItem href="/contact"></BottomMenuItem>
//                     {/* 更多底部菜单项... */}
//                 </div>
//             </div>
...
//                             <img src="/images/icon_ai.webp" alt="AI 创作" />
//                             <p>AI 创作</p>
//                         </div>
//                         <div className={styles.item}>
//                             <img src="/images/icon_question.webp" alt="有趣的问题" />
//                             <p>有趣的问题</p>
//                         </div>
//                         <div className={styles.item}>
//                             <img src="/images/icon_baike.webp" alt="AI百科" />
//                             <p>AI百科</p>
//                         </div>
//                     </div>
